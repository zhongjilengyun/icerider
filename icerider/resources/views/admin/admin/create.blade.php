...
<div class="content_main container-fluid">
    <div id="iframe_home" class="iframe cur">
        ...
        <!--基础信息   部门信息-->
        <div>
            <form class="form-horizontal" role="form" style="margin:0 20px 0 30px;" action="{{url('admin/adminAdd')}}" method="post">
                <div class="form-group">
                    <h4>基础信息</h4>
                    <label for="realNaname" class="col-sm-4 control-label">真实姓名：</label>
                    <div class="col-sm-6">
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                        <input type="text" class="form-control" name="true_name" id="realNaname" placeholder="请输入用户真实姓名">
                    </div>
                </div>
                <div class="form-group">
                    <label for="loginName" class="col-sm-4 control-label">登陆名：</label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="username" id="loginName" placeholder="请输入用户登录名">
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="position" id="Users post" class="selectpicker show-tick form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="rank" id="IClass" class="selectpicker show-tick form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="area_id" id="Regions" class="selectpicker show-tick form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select name="company_id" id="subordinateCompanie" class="selectpicker show-tick form-control">
                ...
                <div class="form-group">
                    <label for="city" class="col-sm-4 control-label">所属省份：</label>
                    <div class="col-sm-6">
                        <select name="province" id="province" class="selectpicker show-tick form-control">
